...
public class InkDialogVariables 
{
    private Dictionary<string, Ink.Runtime.Object> variables;

    public InkDialogVariables(Story story)
    {
        ...
        foreach (string name in story.variablesState)
        {
            ...
            Debug.Log("Initialized global dialogue variable: " + name + " = " + value + "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        }
    }
